...
Class UserController extends Controller {
    ...
    public function infoAction () {
        ...
        if ($userInfo) {
            return array('vipTime' => strtotime($userInfo['vip_time']) * 1000, 'userStatus' => $userInfo['user_status'], 'accessToken' => $userInfo['access_token']);
        } else {
            ...
            return array('vipTime' => 0, 'userStatus' => 1, 'accessToken' => $accessToken);
        }
    }
}
